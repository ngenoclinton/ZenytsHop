      ...
      {productData.map((item: Item) => (
        ...
        >
          ...
          <div>
            ...
            <p className="text-base  py-2">{item.description.substring(0,77)}..</p>
            <div className="flex items-left  md:spaece-x-4 flex-col">
                <p className="text-[#198754] text-lg font-semibold">Ksh {item.price}</p> 
                <p className="text-[#dc3545] text-base line-through ">Ksh {item.oldPrice}</p> 
            </div>
            <div className="flex gap-2 items-center text-[#ffc107]  mt-2">
              ...
              <MdOutlineStar title="Rating" className="hover:text-[#fd7e14]"/>
              <MdOutlineStar title="Rating" className="hover:text-[#fd7e14]"/>
              <MdOutlineStarHalf title="Half Star Rating" className="hover:text-[#fd7e14]"/>
